...
Процедура Тест_Должен_ПолучитьСписокМетодовCТестами() Экспорт
	...
	СписМетодовБезТестов = ",КоличествоЭлементов,ПреобразоватьКонтрагента";

	Ожидаем.Что(СписМетодовСтр).Равно(СписМетодовБезТестов);
...
Процедура Тест_Должен_ПолучитьСписокМетодовБезТестов() Экспорт
	...
	СписМетодовБезТестов = ",ЭтоАдминистратор,ПолучитьСписокОбъектов";
